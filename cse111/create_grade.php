...
<table id="structure">
  <tr>
    ...
    <td id="page">
      <h2>Choose the class that the assignment in</h2>
      ...
      <?php
        ...
        {
        echo "You are not teaching any class this semester so you can't give students grade!<br>";
        } 
        else 
        {
          ...
          {
          ?>
          <a href="add_grade.php?id=<?php echo urlencode($c_id);?>"
